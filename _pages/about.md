...
To achieve this, my work is organized around tighter bidirectional heuristic search and lazy optimal motion planning, with broader interests in kinodynamic motion planning, heuristic search, multi-agent pathfinding,graph-based optimization, and optimal control. I am passionate about pushing the boundaries of autonomous systems by bridging theoretical insights with real-world applications.

I am currently collaborating and working with Professor Sven Koenig, Professor Oren Salzman, and [Dr. Eyal Weiss](https://eyal-weiss.github.io/) to optimize the interplay between sampling-based motion planning and bidirectional heuristic search, a novel framework that significantly improves solution-finding efficiency in high-dimensional continuous state spaces. I also contribute to the [Open motion planning library (OMPL)](https://ompl.kavrakilab.org/developers.html)(since Oct 2025).
...
Selected to present a [lightning talk](https://2025.ijcai.org/doctoral-consortium-program/) at the IJCAI 2025 Doctoral Consortium as one of six lightning talks of selected papers from main conference track.
...
[Main-Track oral presentation](https://2025.ijcai.org/montreal-main-track-accepted-papers/) at IJCAI 2025, Aug 22, Montreal, Canada.

[Lightning talk to the DC of IJCAI25](https://2025.ijcai.org/doctoral-consortium-program/) at IJCAI 2025, Aug 18, Montreal, Canada.
